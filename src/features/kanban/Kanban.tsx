    ...
    <div className="mx-auto max-w-7xl py-10">
      ...
      >
        <div className="flex flex-col w-full items-start gap-y-4">
          ...
          />
          <ShimmerButton onClick={onAddContainer}>Add container</ShimmerButton>
        </div>
      </Modal>
      {/* Add Item Modal */}
      <Modal showModal={showAddItemModal} setShowModal={setShowAddItemModal}>
        <div className="flex flex-col w-full items-start gap-y-4">
          ...
          />
          <ShimmerButton onClick={onAddItem}>Add Item</ShimmerButton>
        </div>
      </Modal>
      <div className="flex items-center justify-between gap-y-2">
        <h1 className="text-gray-800 text-3xl font-bold">KanBan Board</h1>
        <ShimmerButton onClick={() => setShowAddContainerModal(true)}>
          Add Container
        </ShimmerButton>
      </div>
      <div className="mt-10">
